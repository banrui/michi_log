...
public class MainActivity extends Activity {
	...
	private static final String CONSUMER_KEY = "ta9o";
	private static final String CONSUMER_SECRET = "7527a56f83c72df4";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        michiLoadButton.setOnClickListener(new OnClickListener() {
			...
			//startAuth(v);
			Log.d("test", "test");
			 Intent mainLoadActivity = new Intent(MainActivity.this, MainLoadActivity.class);
